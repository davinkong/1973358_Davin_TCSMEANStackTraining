...
let addTask = `
    ...
    <form action="/store" method="get">
        ...
        <input type="date" name="deadline" placeholder="mm-dd-yyyy" value=""
        min="2021-01-01" max="2030-12-31"/><br/>
        <input type="submit" value="Add Task" style="background-color:#00FFFF"/>
    </form>
    <h3 style = "text-decoration: underline">Delete Task</h3>
    <form action="/delete" method="get">
        <label>Task Id</label>
        <input type="text" name="taskId"/><br/>
        <input type="submit" value="Delete Task" style="background-color:#FF6347"/>
    </form>
    <h3 style = "text-decoration: underline">List Tasks</h3>
    <form action="/display" method="get">
        <input type="submit" value="List all tasks" style="background-color: #909090"/>
    </form>
`
